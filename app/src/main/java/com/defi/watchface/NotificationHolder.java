...
public final class NotificationHolder {
    ...
    public static synchronized String getTitle() { return title; }
    public static synchronized String getText() { return text; }
    public static synchronized Bitmap getIcon() { return icon; }
    public static synchronized PendingIntent getContentIntent() { return contentIntent; }
    public static synchronized long getTimestamp() { return timestamp; }
}
